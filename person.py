class Person:
    ...
    def getDailyMacronutrientForMealTimeInGrams(self):
        print(f"Daily carbs grams intake => {self.carbs_grams_intake}g")
        print(f"        Breakfast ({round(0.5 * 100)}%): {0.5 * self.carbs_grams_intake}g")
        print(f"        Lunch ({round(0.3 * 100)}%):     {0.3 * self.carbs_grams_intake}g")
        print(f"        Dinner ({round(0.2 * 100)}%):    {0.2 * self.carbs_grams_intake}g")
        print(f"Daily protein grams intake => {self.protein_grams_intake}g")
        print(f"        Breakfast ({round(0.4 * 100)}%): {0.4 * self.carbs_grams_intake}g")
        print(f"        Lunch ({round(0.4 * 100)}%):     {0.4 * self.carbs_grams_intake}g")
        print(f"        Dinner ({round(0.2 * 100)}%):    {0.2 * self.carbs_grams_intake}g")
        print(f"Daily fat grams intake => {self.fat_grams_intake}g")
        print(f"        of which are saturated => {self.saturated_fat_grams_intake}g")
        print(f"                Breakfast ({round(0.4 * 100)}%): {round(0.4 * self.saturated_fat_grams_intake)}g")
        print(f"                Lunch ({round(0.4 * 100)}%):     {round(0.4 * self.saturated_fat_grams_intake)}g")
        print(f"                Dinner ({round(0.2 * 100)}%):    {round(0.2 * self.saturated_fat_grams_intake)}g")
        print(f"        of which are unsaturated => {self.unsaturated_fat_grams_intake}g")
        print(f"                Breakfast ({round(0.4 * 100)}%): {round(0.4 * self.unsaturated_fat_grams_intake)}g")
        print(f"                Lunch ({round(0.4 * 100)}%):     {round(0.4 * self.unsaturated_fat_grams_intake)}g")
        print(f"                Dinner ({round(0.2 * 100)}%):    {round(0.2 * self.unsaturated_fat_grams_intake)}g")